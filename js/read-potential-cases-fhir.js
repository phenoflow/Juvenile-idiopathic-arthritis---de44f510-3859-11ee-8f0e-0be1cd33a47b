...
(async () => {
  ...
  await fs.writeFile("juvenile-idiopathic-arthritis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("juvenile-idiopathic-arthritis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
